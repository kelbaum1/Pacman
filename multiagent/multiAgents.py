...
class ReflexAgent(Agent):
    ...
    def evaluationFunction(self, currentGameState, action):
        ...
        ghostDistances = map(lambda ghostPos: util.manhattanDistance(newPos, ghostPos), successorGameState.getGhostPositions())
        foodDistances = map(lambda food: util.manhattanDistance(newPos, food), foodList)
        ...
        return newScore - closestFood + closestGhost
